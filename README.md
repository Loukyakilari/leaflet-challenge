...
1. Create a new repository for this project called `leaflet-challenge`, and please select `VisualStudio` as your `.gitignore` template.. **Do not add this homework to an existing repository**.  
